    ...
    try:
        ...
        try:
            ...
            chromedriver_versions = {
                ...
                "windows": "D:/GIT/allroundpython/scrapers/chromedriver/chromedriver.exe",
            }
...
def scrapper(**kwargs):
    try:
        ...
        print("Unable to find config.json at following path: " + str(os.path.join(root,"config.json")))
        exit()
